...
internal class MaskTableTest {
    ...
    @Test
    fun testCreate() {
        val table = MaskTable(DEFAULT_MASK_TABLE_STR)
    ...
    fun testCreateCustomSize() {
        val table = MaskTable("GoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6", 5)
    ...
    @Test
    fun testCreateError() {
        val little = "GoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqT"; //59 char
        checkIllegalState(little)
        val big = "GoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTAA"; //61 char
        checkIllegalState(big)
        val duplicate = "GoQd7ShKu2k9wONaa4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTc";
        checkIllegalState(big) // duplicate: a
        val invalidChar = "GoQd7ShKu2k9wONa%4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTc";
        checkIllegalState(big) // invalidChar: %

    }

    fun checkIllegalState(s: String, rowCount: Int = 6) {
        Assertions.assertThrows(IllegalStateException::class.java) { MaskTable(s, rowCount) }
    }

    @Test
    fun testEncode() {
        val table = MaskTable("GoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTc")
        // rows, col = 0
    ...
    @Test
    fun testEquals(){
        val table1 = MaskTable("GoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTc")
        val table2 = MaskTable("GoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTc")
        val table3 = MaskTable("ZoQd7ShKu2k9wONaC4Hr3mExBU0WgfFn5yP1pIvDLsM8iAtJe6RbVlXjYqTc")
